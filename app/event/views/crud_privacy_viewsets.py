...
from event.serializers.privacy_serializer import PrivacySerializer, PrivacySerializerOut
...
class PrivacyCRUDViewSet(
    ...
    def get_serializer_class(self):
        if 'list' in self.action or 'retrieve' in self.action:
            self.serializer_class = PrivacySerializerOut
        return super().get_serializer_class()

    @swagger_auto_schema(
        operation_summary='Danh sách privacy',
        manual_parameters=[
            openapi.Parameter(
        ...
        ], paginator_inspectors=[PaginatorInspectorClass], tags=['privacy']
    )
    ...
    @swagger_auto_schema(
        operation_summary='Tạo mới privacy', tags=['privacy']
    )
    def create(self, request, *args, **kwargs):
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(
        operation_summary='Chi tiết privacy', tags=['privacy']
    )
    ...
    @swagger_auto_schema(
        operation_summary='Cập nhật privacy', tags=['privacy']
    )
    ...
    @swagger_auto_schema(
        operation_summary='Xóa privacy', tags=['privacy']
    )
