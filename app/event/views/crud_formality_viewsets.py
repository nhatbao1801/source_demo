...
from event.serializers.formality_serializer import FormalitySerializer, FormalitySerializerOut
...
class FormalityCRUDViewSet(
    ...
    def get_serializer_class(self):
        if 'list' in self.action or 'retrieve' in self.action:
            self.serializer_class = FormalitySerializerOut
        return super().get_serializer_class()

    @swagger_auto_schema(
        operation_summary='Danh sách hình thức tổ chức sự kiện',
        manual_parameters=[
            openapi.Parameter(
        ...
        ], paginator_inspectors=[PaginatorInspectorClass], tags=['formality']
    )
    ...
    @swagger_auto_schema(
        operation_summary='Tạo mới hình thức tổ chức sự kiện', tags=['formality']
    )
    def create(self, request, *args, **kwargs):
        return super().create(request, *args, **kwargs)
    
    @swagger_auto_schema(
        operation_summary='Chi tiết hình thức tổ chức sự kiện', tags=['formality']
    )
    ...
    @swagger_auto_schema(
        operation_summary='Cập nhật hình thức tổ chức sự kiện', tags=['formality']
    )
    ...
    @swagger_auto_schema(
        operation_summary='Xóa hình thức tổ chức sự kiện', tags=['formality']
    )
